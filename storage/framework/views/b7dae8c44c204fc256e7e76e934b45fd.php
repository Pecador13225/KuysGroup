  ...
  <nav class="fixed w-full bg-white/10 backdrop-blur-lg shadow-lg z-50 border-b border-white/20">
    <div class="container mx-auto px-6 py-4 flex justify-between items-center">
      <div class="flex items-center gap-3">
        <img src="images/ispsc.png" alt="Users Hub Logo" class="w-10 h-10 rounded-lg shadow-md" />
          ...
          <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr class="border-b hover:bg-indigo-50 transition duration-300">
                ...
                <td class="px-6 py-4">
                  <a href="<?php echo e($user->github_link); ?>" target="_blank" rel="noopener" class="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:opacity-90 shadow-md transition">View</a>
                </td>
              </tr>
